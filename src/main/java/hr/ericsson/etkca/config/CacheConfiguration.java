package hr.ericsson.etkca.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, hr.ericsson.etkca.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, hr.ericsson.etkca.repository.UserRepository.USERS_BY_EMAIL_CACHE);
