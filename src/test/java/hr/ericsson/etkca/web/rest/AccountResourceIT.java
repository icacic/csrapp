...
import hr.ericsson.etkca.config.Constants;
import hr.ericsson.etkca.domain.User;
import hr.ericsson.etkca.repository.AuthorityRepository;
import hr.ericsson.etkca.repository.UserRepository;
import hr.ericsson.etkca.security.AuthoritiesConstants;
import hr.ericsson.etkca.service.UserService;
import hr.ericsson.etkca.service.dto.PasswordChangeDTO;
import hr.ericsson.etkca.service.dto.UserDTO;
import hr.ericsson.etkca.web.rest.vm.KeyAndPasswordVM;
import hr.ericsson.etkca.web.rest.vm.ManagedUserVM;
...
import static hr.ericsson.etkca.web.rest.AccountResourceIT.TEST_USER_LOGIN;
