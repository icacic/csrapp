...
import hr.ericsson.etkca.config.audit.AuditEventConverter;
import hr.ericsson.etkca.domain.PersistentAuditEvent;
...
import static hr.ericsson.etkca.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
